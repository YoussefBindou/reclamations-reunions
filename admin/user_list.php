                ...
                <div class="table-container">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                            if ($user == "admin") {
                                $query = "SELECT * FROM user JOIN bureau ON user.Bureau = bureau.id_Bureau WHERE user != 'admin'";
                            } 
                            else {
                                $query = "SELECT * FROM user JOIN bureau ON user.Bureau = bureau.id_Bureau WHERE admin_y_n = 0";
                            }
