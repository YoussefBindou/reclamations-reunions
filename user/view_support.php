          ...
          <div class="card-body bg-light">
            <div class="container">
              <form method="post" id="contact-form" role="form" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to send this?');">
                ...
                <div class="row">
                  <div class="col-md-12">
                  <a href="repon.php?id=<?php echo $supportId ?>" class="btn btn-secondary btn-block">Check Reponse</a>
                    <a href="../user/seport_list.php" class="btn btn-secondary btn-block">Go Back</a>
                  </div>
                </div>
              </form>
            </div>
